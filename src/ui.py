...
from PyQt4.QtCore import Qt, QRect, QRectF, QSizeF, QPointF, pyqtSignal, \
                         QPropertyAnimation
from PyQt4.QtGui import QWidget, QPainter, QColor, QBrush, QPen, QFont, \
                        QHBoxLayout, QVBoxLayout, QGraphicsItem, \
                        QGraphicsScene, QGraphicsView, QGroupBox, QLabel, \
